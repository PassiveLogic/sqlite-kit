...
//        .package(url: "https://github.com/vapor/sqlite-nio.git", from: "1.9.0"),
        .package(url: "https://github.com/PassiveLogic/sqlite-nio.git", branch: "feat/khasm-PAL-2026-v3"),
        .package(url: "https://github.com/vapor/sql-kit.git", from: "3.33.1"),
//        .package(url: "https://github.com/vapor/async-kit.git", from: "1.19.0"),
        .package(url: "https://github.com/PassiveLogic/async-kit.git", branch: "feat/khasm-PAL-2026-v3"),
    ],
    targets: [
        .target(
            name: "SQLiteKit",
